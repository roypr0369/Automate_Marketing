...
class InstagramCrew():
	...
	def content_strategy_task(self) -> Task:
		return Task(
			config=self.agents_config['content_strategy'],
	...
	def visual_content_creation_task(self) -> Task:
		return Task(
			config=self.agents_config['visual_content_creation'],
	...
	def copywriting_task(self) -> Task:
		return Task(
			config=self.agents_config['copywriting'],
	...
	def report_final_content_strategy(self) -> Task:
		return Task(
			config=self.agents_config['report_final_content_strategy'],
			agent=self.content_strategist(),
